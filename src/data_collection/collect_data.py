                ...
                try:
                    ...
                    if status == "REQUEST_DENIED":
                        ...
                        if "expired" in error_msg.lower() or "expired" in str(error_msg).lower():
                            print(f"\n[error] Google Places API key error: {error_msg}")
                            print(f"[error] Status: {status}\n")
                            print("[info] This error can occur for several reasons:")
                            print("  1. **New API Key Not Yet Activated**:")
                            print("     - New Google API keys can take up to 10 minutes to become active")
                            print("     - Wait 10 minutes and try again")
                            print("  2. **API Key Actually Expired/Invalid**:")
                            print("     - Go to https://console.cloud.google.com/apis/credentials")
                            print("     - Check if your API key exists and is valid")
                            print("     - If needed, create a new API key and update your .env file")
                            ...
                            print("     - Check API quotas at https://console.cloud.google.com/apis/api/places-backend.googleapis.com/quotas")
                            print("  4. **API Key Restrictions**:")
                            print("     - Go to https://console.cloud.google.com/apis/credentials")
                            print("     - Click on your API key")
                            print("     - Under 'API restrictions', ensure 'Places API' (legacy) is enabled")
                            print("     - If you have IP/HTTP referrer restrictions, ensure they allow your requests")
                            print("\n")
                            raise RuntimeError(f"API key error: {error_msg}. See instructions above to resolve.")
                        else:
